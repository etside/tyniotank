  ...
  return (
    <motion.div layout initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}
      ...
      <div className="flex items-start gap-3">
        ...
        {p.status === "live" && (
          <span className="ml-auto flex items-center gap-1.5 rounded-full bg-[#D50000]/15 px-2.5 py-1 text-[11px] font-bold text-[#FF5252]">
...
export default function Lobby() {
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[220px_1fr]">
      ...
      <div>
        <h1 className="text-2xl font-extrabold tracking-tight">Investor Lobby</h1>
